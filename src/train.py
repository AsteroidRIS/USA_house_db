...
if __name__ == "__main__":
    target = "price"
    train_path = "E:\\USA_house_DB\\data\\train_validate.csv"
    ...
    with open('E:\\USA_house_DB\\models\\encoded.pickle', 'wb') as handle:
    ...
    file_name = "E:\\USA_house_DB\\models\\regression.pickle"
    ...
    print("Saving the model.")
    file_name = "E:\\USA_house_DB\\models\\decision.pickle"
    ...
    print("Saving the model.")
    file_name = "E:\\USA_house_DB\\models\\knearest.pickle"
